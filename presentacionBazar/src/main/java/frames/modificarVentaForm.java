 ...
 * @author ID145
 */
public class modificarVentaForm extends javax.swing.JFrame {

    /**
     * Creates new form agregarVentaForm
     */
    public modificarVentaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(80, 360, 140, 130);
    ...
    private void botonCompletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCompletarActionPerformed
        ...
        if (nombreCliente.isEmpty() || apellidoCliente.isEmpty() || pagoConStr.isEmpty()) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Todos los campos deben estar llenos.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (tablaProductosEnVenta.getRowCount() == 0) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "La tabla de productos a vender no puede estar vacía.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Validar nombre del cliente
        if (!nombreCliente.matches("^[a-zA-Z]+$")) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Nombre del Cliente solo puede contener letras.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Validar apellido del cliente
        if (!apellidoCliente.matches("^[a-zA-Z]+$")) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Apellido del Cliente solo puede contener letras.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Total debe ser un número válido.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Pago Con debe ser un número válido.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if (pagoCon < total) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Pago Con debe ser mayor o igual al Total.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if (pagoCon < 0) {
            JOptionPane.showMessageDialog(modificarVentaForm.this, "Pago Con no puede ser negativo.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }


        // Si todas las validaciones son exitosas, proceder con la lógica de completar la venta
        JOptionPane.showMessageDialog(modificarVentaForm.this, "Venta completada exitosamente.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarVentaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarVentaForm().setVisible(true);
            }
        });
    }
