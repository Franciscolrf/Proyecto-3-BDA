...
public class ventasFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre Cliente", "Apellido Cliente", "Método de Pago", "Total", "Fecha de Venta"
            }
        ) {
        ...
        jPanel2.setBounds(630, 140, 200, 310);

        botonEliminar.setText("Eliminar");
        getContentPane().add(botonEliminar);
        botonEliminar.setBounds(530, 490, 73, 23);

        botonModificar.setText("Modificar");
        getContentPane().add(botonModificar);
        botonModificar.setBounds(350, 490, 90, 23);
