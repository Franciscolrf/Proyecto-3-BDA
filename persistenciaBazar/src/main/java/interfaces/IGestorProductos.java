...
//    public List<ProductoDTO> consultarProductosPorProveedor(ProveedorDTO proveedor) throws DAOException;
     ...
     *
     * @param producto
     * @throws excepciones.DAOException en caso de que no se pueda registrar el
     * producto
     */
     ...
     * @throws excepciones.DAOException En caso de que no se pueda actualizar el
     * producto o error.
     */
     ...
     * @throws excepciones.DAOException En caso de que no se pueda eliminar el
     * producto.
     */
