...
public class UsuarioDTO {
    ...
    /**
     * Crea una instancia con la informacion de un usuario en el sistema.
     * 
     ...
     * @param direccion     La dirección del usuario.
     */
    public UsuarioDTO(String nombre, String apellido, String codigoInterno, Date fechaContratacion, Puesto puesto,
            String telefono,
            String contrasena, DireccionDTO direccion) {
        this.nombre = nombre;
        this.apellido = apellido;
     ...
     *
     * @param codigoInterno Una cadena que representa el código interno a
     *                      establecer.
     */
     ...
     *
     * @param fechaContratacion Un objeto Date que representa la fecha de
     *                          contratación a establecer.
     */
     ...
     *
     * @param direccion Un objeto DireccionDTO que representa la dirección a
     *                  establecer.
     */
